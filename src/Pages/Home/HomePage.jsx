  ...
  return (
    <Box sx={{width:"100%", minHeight:"100vh"}}>
        ...
        <Stack sx={{flexDirection:"row", gap:"30px", alignItems:"center"}}>  
          ...
          <Button sx={{bgcolor:'#d90166', borderRadius:"15px", minWidth:"200px"}} variant='contained'><RxHome size={28} /> <Typography color='white' variant='h6' component="h2" sx={{fontWeight:500, fontSize:"20px", marginLeft:"10px", textTransform: "none"}}> Airbnb Setup</Typography></Button>
        </Stack>
        </Stack>
    </Box>
  )
